...
class NSArray:
    ...
    @classmethod
    def arrayWithObjects_count_(
        cls, objects: Tuple[Any, ...], count: int
    ) -> "NSArray": ...
    @classmethod
...
class NSNotification:
    ...
    @classmethod
    def notificationWithName_object_(
        cls, name: str, object: Any
    ) -> "NSNotification": ...
    @classmethod
...
def FSEventStreamScheduleWithRunLoop(
    stream: FSEventStreamRef, runLoop: Any, runLoopMode: str
) -> None: ...
