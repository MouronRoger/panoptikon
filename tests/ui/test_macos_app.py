...
class TestFileSearchApp:
            ...
            with patch.dict(sys.modules, {"AppKit": None, "Foundation": None}):
                ...
                with patch("builtins.__import__", 
                           side_effect=lambda name, *args, **kwargs: 
                               ImportError() if name in ("AppKit", "Foundation", "objc") 
                               else __import__(name, *args, **kwargs)):
                    app = FileSearchApp()
                    assert app._pyobjc_available is False
                    mock_setup.assert_not_called()
    
    def test_init_with_pyobjc(self, mock_objc_modules: None, mock_wrappers: None) -> None:
    ...
    def test_search_functions(self, mock_objc_modules: None, mock_wrappers: None) -> None:
    ...
    def test_search_option_changed(self, mock_objc_modules: None, mock_wrappers: None) -> None:
    ...
    def test_show_with_pyobjc(self, mock_objc_modules: None, mock_wrappers: None) -> None:
        ...
        with (
            ...
            try:
                # Replace with mock
                sys.modules["AppKit"].NSApplication.sharedApplication = MagicMock(return_value=app_mock)
